...
function Building() {
  return (
    ...
    <div >
      <img
        src="https://www.urbansciencemep.com/_next/static/images/Building%20services-665e19133c29e6b3e7f285487e969592.jpg"
        alt="back"
        width={1480}
      />
    </div>

    <div style={{ textAlign: "justify", width: "80%", margin: "40px auto",padding:"60px" }}>
      <h1 style={{ margin: "40px",textAlign:"center",color:"#596AFF" }}>MEP Buildind Services</h1>
      <p style={{padding:"10px"}}>
        ...
        services, so you can rest assured that all your needs will be taken
        care of. We don't just provide one service but many - from community
        management to urban planning to project management and more! With our
        team of industry specialists, you'll never want to go anywhere else.
