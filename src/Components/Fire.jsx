...
function Fire() {
  return (
    ...
    <div >
      <img
        src="https://www.urbansciencemep.com/_next/static/images/fire%20page-52ef6b18761477396076c7828f67e90a.jpg"
        alt="back"
        width={1480}
      />
    </div>
    ...
    <div style={{ textAlign: "justify", width: "80%", margin: "40px auto",padding:"60px" }}>
      <h1 style={{ margin: "40px",textAlign:"center",color:"#596AFF" }}>Fire System</h1>
